...
class PressBook_Blog_Editor extends PressBook\Editor {
	...
	public function load_editor_fonts_css() {
		...
		if ( 'off' !== $raleway ) {
			$fonts_css .= ( '.block-editor-page .editor-styles-wrapper{font-family:\'Raleway\', sans-serif;}' );
		}
		...
		if ( 'off' !== $source_sans_pro ) {
			$fonts_css .= ( '.editor-styles-wrapper .editor-post-title .editor-post-title__input,.editor-styles-wrapper h1,.editor-styles-wrapper h2,.editor-styles-wrapper h3,.editor-styles-wrapper h4,.editor-styles-wrapper h5,.editor-styles-wrapper h6{font-family:\'Source Sans Pro\', sans-serif;}' );
		}
