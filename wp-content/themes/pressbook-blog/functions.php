...
define( 'PRESSBOOK_BLOG_VERSION', '1.0.2' );
...
function pressbook_blog_services( $services ) {
	require get_stylesheet_directory() . '/classes/class-pressbook-blog-select-multiple.php';
	require get_stylesheet_directory() . '/classes/class-pressbook-blog-cssrules.php';
	require get_stylesheet_directory() . '/classes/class-pressbook-blog-scripts.php';
	require get_stylesheet_directory() . '/classes/class-pressbook-blog-editor.php';
	require get_stylesheet_directory() . '/classes/class-pressbook-blog-posts-grid.php';
	require get_stylesheet_directory() . '/classes/class-pressbook-blog-posts-grid-header.php';
	require get_stylesheet_directory() . '/classes/class-pressbook-blog-posts-grid-related.php';
	require get_stylesheet_directory() . '/classes/class-pressbook-blog-upsell.php';
